...
//
//	var err error
//	table.Resolver, err = b.buildResolverDefinition(table, &config.FunctionConfig{
...
//		table.IgnoreErrorFunc, err = b.buildResolverDefinition(table, resource.IgnoreError)
//		if err != nil {
//			return err
//		}
//	}
//	if resource.Multiplex != nil {
//		table.MultiplexFunc, err = b.buildResolverDefinition(table, resource.Multiplex)
//		if err != nil {
//			return err
//		}
//	}
...
//		table.DeleteFilterFunc, err = b.buildResolverDefinition(table, resource.DeleteFilter)
//		if err != nil {
//			return err
//		}
//	}
//	if resource.PostResourceResolver != nil {
//		table.PostResourceResolver, err = b.buildResolverDefinition(table, resource.PostResourceResolver)
//		if err != nil {
//			return err
//		}
//	}
...
//}
//
//func (b builder) buildResolverDefinition(table *TableDefinition, cfg *config.FunctionConfig) (*ResolverDefinition, error) {
...
//			}
//			columnResolver, err := b.buildResolverDefinition(table, &config.FunctionConfig{
