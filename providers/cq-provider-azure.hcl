...
resource "azure" "sql" "servers" {
  ...
  relation "sql" "server" "db_blob_auditing_policies"{
    path        = "github.com/Azure/azure-sdk-for-go/services/sql/mgmt/2014-04-01/sql.ServerBlobAuditingPolicy"
  }

  relation "sql" "server" "devops_audit_settings"{
    path        = "github.com/Azure/azure-sdk-for-go/services/sql/mgmt/2014-04-01/sql.ServerDevOpsAuditingSettings"
  }
